...
async function seedCampaign() {
  ...
  const { error: pageErr } = await supabase.from("campaign_pages").upsert({
    ...
    subtitle_ka: "ბითიეი ლაბი — შენი იდეის პარტნიორი",
    subtitle_en: "BTA LAB — Your Idea Partner",
    description_ka: "ბითიეი ლაბის მეწარმის მხარდაჭერის კამპანია გთავაზობთ დაფინანსებას, ტექნიკურ მხარდაჭერას და პროფესიონალურ გარემოს ციფრული პროექტების განსავითარებლად.",
  ...
  const { error: seoErr } = await supabase.from("campaign_seo").upsert({
    id: seoId,
    page_slug: PAGE_SLUG,
    title_ka: "მეწარმის მხარდაჭერის კამპანია | ბითიეი ლაბი",
    title_en: "Entrepreneur Support Campaign | BTA LAB",
    description_ka: "ბითიეი ლაბის მეწარმის მხარდაჭერის კამპანია — მიიღეთ დაფინანსება და პროფესიონალური მხარდაჭერა თქვენი ციფრული პროექტის განსავითარებლად.",
    ...
    keywords_ka: "მეწარმე, მხარდაჭერა, დაფინანსება, ციფრული პროექტი, ბითიეი ლაბი, სტარტაპი",
    ...
    og_title_ka: "მეწარმის მხარდაჭერის კამპანია | ბითიეი ლაბი",
  ...
  const settings = [
    ...
    { key: "campaign_facebook_url", v_ka: "https://www.facebook.com/bta.lab.official", v_en: "https://www.facebook.com/bta.lab.official", type: "url" },
    { key: "campaign_facebook_label", v_ka: "@bta.lab.official", v_en: "@bta.lab.official", type: "text" },
    { key: "campaign_instagram_url", v_ka: "https://www.instagram.com/bta.lab.official", v_en: "https://www.instagram.com/bta.lab.official", type: "url" },
    { key: "campaign_instagram_label", v_ka: "@bta.lab.official", v_en: "@bta.lab.official", type: "text" },
    { key: "campaign_tiktok_url", v_ka: "https://www.tiktok.com/@bta.lab.official", v_en: "https://www.tiktok.com/@bta.lab.official", type: "url" },
    { key: "campaign_tiktok_label", v_ka: "@bta.lab.official", v_en: "@bta.lab.official", type: "text" },
  ];
...
• Start or enhance their digital transformation.`,
    ...
    { sk: "portfolio", st: "cards", order: 14,
      ...
      desc_ka: "წარმატებული პროექტების მაგალითები, რომლებიც შეიქმნა ბითიეი ლაბის მხარდაჭერით.",
    ...
    { sk: "branding", st: "content", order: 15,
      ...
      desc_ka: "ბითიეი ლაბი უზრუნველყოფს პროექტის ბრენდინგის მხარდაჭერას, მათ შორის ლოგოს დიზაინს, ფერების სქემას და ვიზუალურ იდენტობას.",
    ...
    { sk: "futureChanges", st: "content", order: 16,
      ...
      desc_ka: "კამპანიის პირობები შესაძლოა შეიცვალოს ბითიეი ლაბის გადაწყვეტილებით. ცვლილებების შესახებ მონაწილეები წინასწარ გაფრთხილდებიან.",
  ...
  const faqItems = [
    { q_ka: "რა არის მეწარმის მხარდაჭერის კამპანია?", q_en: "What is the Entrepreneur Support Campaign?",
      a_ka: "ეს არის ბითიეი ლაბის ინიციატივა, რომელიც მიზნად ისახავს დაეხმაროს მეწარმეებსა და სტარტაპებს ციფრული პროდუქტების შექმნაში. ჩვენ გთავაზობთ დაფინანსებას, ტექნიკურ მხარდაჭერას და მენტორინგს.",
    ...
    { q_ka: "მჭირდება თუ არა ტექნიკური ცოდნა?", q_en: "Do I need technical knowledge?",
      a_ka: "არა, თქვენ არ გჭირდებათ ტექნიკური ცოდნა. ბითიეი ლაბის გუნდი უზრუნველყოფს სრულ ტექნიკურ მხარდაჭერას.",
    ...
    { q_ka: "რა ხდება განაცხადის დამტკიცების შემდეგ?", q_en: "What happens after application approval?",
      a_ka: "დამტკიცების შემდეგ იდება ხელშეკრულება, განისაზღვრება პროექტის გეგმა და ვადები, და იწყება პროექტზე მუშაობა ბითიეი ლაბის გუნდთან ერთად.",
