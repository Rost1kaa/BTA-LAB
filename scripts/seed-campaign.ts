...
async function seedCampaign() {
  ...
  const settings = [
    ...
    { key: "campaign_email", v_ka: "campaign@bta.edu.ge", v_en: "campaign@bta.edu.ge", type: "text" },
    { key: "campaign_phone", v_ka: "+995 555 123 456", v_en: "+995 555 123 456", type: "text" },
  ...
  const sections = [
    // Hero
    {
      ...
      desc_ka: `ბიზნესისა და ტექნოლოგიების აკადემიის საწარმო იწყებს მცირე და საშუალო მეწარმეების, დამწყები ბიზნესებისა და ორგანიზაციების ციფრული განვითარების მხარდამჭერ კამპანიას. კამპანიის ფარგლებში შეირჩევა 10 პროექტი, რომლებიც მიიღებენ ვებგვერდის შექმნის მომსახურების 100%, 60% ან 30%-იან დაფინანსებას.`,
...
• Start or enhance their digital transformation.`,
  ...
  const emailTemplates = [
    { event: "application_received",
      sub_ka: "განაცხადი მიღებულია — BTA LAB", sub_en: "Application Received — BTA LAB",
    ...
    { event: "interview_invitation",
      sub_ka: "გასაუბრების მოწვევა — BTA LAB", sub_en: "Interview Invitation — BTA LAB",
    ...
    { event: "need_more_information",
      sub_ka: "დამატებითი ინფორმაცია — BTA LAB", sub_en: "Additional Information Needed — BTA LAB",
    ...
    { event: "offer_made",
      sub_ka: "შეთავაზება — BTA LAB", sub_en: "Offer — BTA LAB",
    ...
    { event: "status_changed",
      sub_ka: "სტატუსის ცვლილება — BTA LAB", sub_en: "Status Change — BTA LAB",
      body_ka: "თქვენი განაცხადის სტატუსი შეიცვალა: {{status}}.",
      body_en: "Your application status has changed to: {{status}}." },
    { event: "final_decision",
      sub_ka: "საბოლოო გადაწყვეტილება — BTA LAB", sub_en: "Final Decision — BTA LAB",
