...
export function Navigation({ siteConfig }: NavigationProps) {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-6 md:px-8 lg:px-12">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            {/* Desktop Navigation */}
            <nav className="hidden header:flex items-center gap-1">
            ...
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                className="relative z-10 flex header:hidden items-center justify-center w-10 h-10 rounded-xl text-[var(--color-fg-secondary)] hover:text-[var(--color-fg-primary)] hover:bg-[var(--color-overlay)] transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-border-subtle)]"
      ...
      {mobileOpen && (
          <div className="fixed inset-0 z-40 bg-[var(--color-bg-primary)]/95 backdrop-blur-2xl header:hidden mobile-menu-fade">
