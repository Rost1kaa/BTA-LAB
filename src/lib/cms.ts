...
export const CONTENT_KEYS = {
  ...
  contact: {
    hero: ["badge", "heading", "description"],
    form: ["name", "namePlaceholder", "email", "emailPlaceholder", "phone", "phonePlaceholder", "company", "companyPlaceholder", "message", "messagePlaceholder", "submit", "successTitle", "successDescription", "sendAnother"],
  },
} as const;
