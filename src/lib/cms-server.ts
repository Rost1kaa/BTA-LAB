...
const getCachedContentRows = unstable_cache(
  ...
  ["cms-content"],
  { revalidate: 30, tags: ["cms-content"] }
);
...
const getCachedSettingsRows = unstable_cache(
  ...
  ["cms-settings"],
  { revalidate: 30, tags: ["cms-settings"] }
);
...
const getCachedPublishedProjects = unstable_cache(
  ...
  { revalidate: 30, tags: ["cms-projects"] }
);
...
const getCachedTeamMembers = unstable_cache(
  ...
  ["cms-team"],
  { revalidate: 30, tags: ["cms-team", "cms-stats"] }
);
...
const getCachedServicePackages = unstable_cache(
  ...
  ["cms-services"],
  { revalidate: 30, tags: ["cms-services", "cms-stats"] }
);
...
const getCachedStatsData = unstable_cache(
  ...
  ["cms-stats"],
  { revalidate: 30, tags: ["cms-stats", "cms-settings"] }
);
