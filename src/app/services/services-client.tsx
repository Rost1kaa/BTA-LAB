...
function ServicesPageContent({
  ...
  return (
    <>
      ...
      <Section id="web-development" className="py-20 lg:py-24 bg-[var(--color-bg-secondary)] scroll-mt-24">
        <Container>
          <PricingSectionBlock
          ...
          <FadeIn direction="up" delay={0.2}>
            <div className="mt-12 mx-auto max-w-4xl">
              <div className="rounded-2xl border border-[var(--color-border-secondary)] bg-[var(--color-overlay)] px-6 py-6 md:px-8 md:py-7">
      ...
      {/* Add-ons */}
      <Section id="additional-services" className="py-20 lg:py-24 bg-[var(--color-bg-secondary)] scroll-mt-24">
        <Container>
          <FadeIn direction="up">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-gradient">
              {content.addons?.title || t("services.addons.title")}
            </h2>
            <p className="mt-4 max-w-4xl text-base md:text-lg text-[var(--color-fg-tertiary)] leading-relaxed">
              {content.addons?.description || t("services.addons.description")}
            </p>
          </FadeIn>

          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-stretch">
      ...
      {/* Service Request Form Modal — AnimatePresence handles exit animation */}
      <AnimatePresence>
